...
export const ERROR_MESSAGES = {
  ...
  PREVIEW_PLACEHOLDER: `
      <p style="font-size: 0.8em; color: var(--text-secondary); margin: 50px; text-align: center;">
        Nothing to preview, <span style="color: var(--text-accent)">enter HTML</span> content to see the result.
      </p>`,
